...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
    [0] = LAYOUT(
        KC_GRV,  KC_F1, KC_F2, KC_F3, KC_F4, KC_F5,  KC_DOWN,
        KC_GRV,  KC_1,  KC_2,  KC_3,  KC_4,  KC_5,   KC_DOWN,
        KC_TAB,  KC_Q,  KC_W,  KC_E,  KC_R,  KC_T,   KC_EQL,
        KC_ESC,  KC_A,  KC_S,  KC_D,  KC_F,  KC_G,   KC_DOWN,

        KC_DOWN, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10,  KC_F11,
        KC_GRV,  KC_6,  KC_7,  KC_8,  KC_9,  KC_0,    KC_DOWN,
