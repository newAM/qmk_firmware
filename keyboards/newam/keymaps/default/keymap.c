...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAY_D] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI,        KC_LALT, KC_LEFT, KC_RGHT, KC_0,    KC_1,        KC_UP,   KC_DOWN, KC_VOLU, KC_VOLD, MO(LAY_F), KC_2,              KC_3,
        KC_4,    KC_5,           KC_6,
        KC_7,    KC_8,           KC_9
    ),
    ...
    [LAY_N] = LAYOUT(
        ...
        _______, _______,  _______,  _______,  _______, _______, _______,    _______, _______,  _______,  _______, _______, _______, _______,
        _______, _______,  KC_AMPR,  KC_LCBR,  KC_RCBR, _______, _______,    _______, _______,  KC_7,     KC_8,    KC_9,    _______, _______,
        _______, _______,  KC_ASTR,  KC_LPRN,  KC_RPRN, _______, _______,    _______, _______,  KC_4,     KC_5,    KC_6,    _______, _______,
        _______, _______,  _______,  KC_LBRC,  KC_RBRC, _______, _______,    _______, _______,  KC_1,     KC_2,    KC_3,    _______, _______,
        _______, _______,  _______,  _______,  _______, _______, _______,    _______, _______,  KC_0,     KC_DOT,  KC_0,    KC_EQL, _______,
